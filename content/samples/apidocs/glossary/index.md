...
| `processed`      | Transaction associated with the fare record has been processed by PSP. If `final_amount` = “0” due to the applied coupon, the fare receives the “processed” `fare_status` without sending anything to the PSP.               | “04: success”                                                                                                                              |
| `partial_refund` | A fare has been partially refunded. If a fare has at least one “processed” refund and `refundable_total` is >0 and < `final_amount`, the `fare_status` is “partial_refund” with the `status_msg` = “20: partially_refunded”. | “20: partially_refunded”                                                                                                                   |
| `refunded`       | A fare has been fully refunded. If a fare has at least one “processed” refund and `refundable_total` is =0, the `fare_status` is “refunded” with the `status_msg` = “21: refunded”.                                          | “21: refunded”                                                                                                                             |
